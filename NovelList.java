public class NovelList {
    ...
    public NodeBukuPeminjam cariNovel(String judulBuku) {
        NodeBukuPeminjam temp = head;
        while (temp != null) {
            if (temp.judul.trim().equalsIgnoreCase(judulBuku.trim())) {
                return temp; // Novel ditemukan
            }
            temp = temp.next;
        }
        return null; // Novel tidak ditemukan
    }
